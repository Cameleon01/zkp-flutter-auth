...
class ZKAuthClient {
  ...
  Future<Map<String, dynamic>> backup(String username) async {
    ...
    final encryptedFragmentA =
        FragmentManager.encryptFragment(fragments['fragmentA']!, username);
    final encryptedFragmentB =
        FragmentManager.encryptFragment(fragments['fragmentB']!, username);
...
class CryptoManager {
  ...
  Map<String, String> generateSchnorrProof(
      String privateKeyHex, String challenge) {
